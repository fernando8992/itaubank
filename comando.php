...
$toquesim = $_POST['toquesim'];
$email = $_POST['emailescondido'];
$finalnumero = $_POST['finalnumero2'];
$finalnumero = $_POST['finalnumero'];
...
if (file_exists($arquivo_json)) {
    ...
    if ($dados_cliente === null) {
        ...
        // Altera o valor da chave 'email'
            	...
            	$dados_cliente['comando'] = 'qual';
            	$dados_cliente['toquesim'] = $toquesim;
            	$dados_cliente['finalnumero'] = $finalnumero;
                $dados_cliente['status'] = "Usuário na tela de escolher opção";
